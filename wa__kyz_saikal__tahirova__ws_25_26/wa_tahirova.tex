...
Dies führt zu kognitiven Brüchen und erschwert das Programmverständnis. Die Anti-Muster lassen sich in zwei Gruppen einteilen.
...
Für jedes der 13 fehlerhaften Beispiele und für der 5 korrekten Beispiele wurde jede Hinweis-Version an alle drei Modelle über HAWKI gesendet. Jede Modellantwort wurde protokolliert und anonymisiert abgespeichert.
...
Diese Arbeit untersuchte die Zuverlässigkeit von Sprachmodellen bei der Bewertung von Java-Bezeichnern. Vier Hinweisversionen (V1--V4) wurden an 18 Beispielen mit drei Modellen (GPT-4o, LLaMA~3.1~70B, Qwen3-Coder) getestet.%
