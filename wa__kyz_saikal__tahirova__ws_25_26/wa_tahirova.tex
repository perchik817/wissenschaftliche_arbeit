...
Entwickler bei Analyse- und Review-Aufgaben zu unterstützen \cite{softwarejudges2025,causalperspective2026}. Ein wichtiger
Anwendungsbereich ist die Bewertung von Bezeichnern im Quellcode. Klare und
verständliche Namen vereinfachen die Wartung, während unklare Bezeichner
...
\cite{llmsmells2025,llmmethodnames2025,automaticprogramming2025}.
...
\cite{automaticprogramming2025}. Studien zeigen jedoch, dass LLMs zwar Muster
...
\textit{Kategorie E1.} Pluralname bei Typ im Singular:
\begin{lstlisting}
...
\subsection{Prompts-Strategien und Iteration für LLMs}
...
Dieses Vorgehen folgt aktuellen Forschungsergebnissen, die die Bedeutung von Hinweis-Gestaltung und Iteration bei der Codeanalyse hervorheben \cite{llmmethodnames2025, automaticprogramming2025}.
...
Alle Sprachmodelleantworten wurden in Textdateien gespeichert und nach Prompt-Version und Modell organisiert. Für jede Version V1--V4 existiert
ein Ordner (v1--v4), der jeweils Unterordner für die drei Modelle (\texttt{openai\_gpt, meta\_llama, alibaba\_qwen}) enthält. Die Dateien sind nach
den in Abschnitt~3.2 beschriebenen Beispielen benannt (z.\,B.\ \texttt{a1.txt, d1\_richtig.txt}). Zusätzlich fasst die Datei \texttt{modellantworten\_tabelle.xlsx} die Bewertungen der Antworten tabellarisch zusammen.

Sämtliche Dateien sind im GitHub-Repository \cite{githubrepository} öffentlich zugänglich und ermöglichen die Nachvollziehbarkeit der Experimente.
...
\begin{enumerate}
    ...
    \item \textbf{Semantische Klarheit.} Sind die neuen Namen verständlich, und vermeiden die neu vorgeschlagenen Namen linguistische Anti-Muster?
...
\begin{thebibliography}{99}
    ...
    Arnaoudova, V., Di Penta, M., \& Antoniol, G. (2016).
    Linguistic Antipatterns: What They Are and How Developers Perceive Them.
    \textit{Empirical Software Engineering}, 21(1), 104–158.
    DOI: \url{https://doi.org/10.1007/s10664-014-9350-8}
    (abgerufen am 17.02.2026).
    ...
    \bibitem{automaticprogramming2025}
    Lyu, M. R., Ray, B., Roychoudhury, A., Tan, S. H., \& Thongtanunam, P. (2025).
    Automatic Programming: Large Language Models and Beyond.
    \textit{ACM Transactions on Software Engineering and Methodology}, 34(5), Article 140, 33 Seiten.
    DOI: \url{https://doi.org/10.1145/3708519}
    (abgerufen am 17.02.2026).
    ...
    In: \textit{14th European Conference on Software Maintenance and Reengineering (CSMR)},
    15–18 March 2010, Madrid, Spain, pp. 156–165.
    IEEE.
    DOI: \url{https://doi.org/10.1109/CSMR.2010.27}
    (abgerufen am 17.02.2026).
    ...
    DOI: \url{https://doi.org/10.48550/arXiv.2510.03029}
    (abgerufen am 17.02.2026).
    ...
    \textit{arXiv preprint}.
    DOI: \url{https://doi.org/10.48550/arXiv.2508.00700}
    (abgerufen am 17.02.2026).

    \bibitem{llmlargevulnbenchmark2025}
    Gnieciak, D., \& Szandala, T. (2025).
    Large Language Models Versus Static Code Analysis Tools: A Systematic Benchmark for Vulnerability Detection.
    \textit{arXiv preprint}.
    DOI: \url{https://doi.org/10.48550/arXiv.2508.04448}
    (abgerufen am 17.02.2026).
    ...
    \textit{Proceedings of the ACM on Software Engineering}, 2(FSE), Article FSE036, 22 Seiten.
    DOI: \url{https://doi.org/10.1145/3715753}
    (abgerufen am 17.02.2026).
    ...
    \textit{Electronics}, 14(3), 586.
    DOI: \url{https://doi.org/10.3390/electronics14030586}
    (abgerufen am 17.02.2026).

    \bibitem{softwarejudges2025}
    He, J., Shi, J., Zhuo, T. Y., Lo, D., et al. (2025).
    From Code to Courtroom: LLMs as the New Software Judges.
    \textit{arXiv preprint}.
    DOI: \url{https://doi.org/10.48550/arXiv.2503.02246}
    (abgerufen am 17.02.2026).

    \bibitem{causalperspective2026}
    Velasco, A., Rodriguez-Cardenas, D., Khati, D., Palacio, D. N., Alif, L. R., \& Poshyvanyk, D. (2026).
    A Causal Perspective on Measuring, Explaining and Mitigating Smells in LLM-Generated Code.
    In: \textit{48th IEEE/ACM International Conference on Software Engineering (ICSE ’26)},
    12–18 April 2026, Rio de Janeiro, Brazil, ACM, 12 Seiten.
    Verfügbar unter: \url{https://arxiv.org/abs/2511.15817}
    (abgerufen am 17.02.2026).

    \bibitem{githubrepository}
    Tahirova, K. S. (2025).
    Chatlogs und Auswertungstabellen zur Nutzung von Sprachmodellen zur Verbesserung von Bezeichnern in Java-Programmen.
    GitHub-Repository.
    Verfügbar unter: \url{https://github.fh-zwickau.de/kyt25p22/chatlogs_auswertungstabellen.git}
    (abgerufen am 17.02.2026).
